...
import com.rotbeyar.app.presentation.feture.purchase.component.PurchaseWayCard
...
@Composable
fun ExamInfoScreen(modifier: Modifier = Modifier,
    ...
    StandardBoxPage(modifier = modifier) {
        ExamInfoContent(modifier = Modifier.padding(16.dp),
            selectedExams = state.examTypes,
            onClickCard = {viewModel.onAction(CompletePurchaseDetailAction.ExamTypeClicked(it))}
        )
